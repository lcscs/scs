...
mkdir -p ${PROJECT}/${VERSION}/opt/lcscs/lib/cmake
...
echo "class lcscs < Formula

   homepage \"${URL}\"
   revision 0
   url \"https://github.com/lcscs/scs/archive/v${VERSION}.tar.gz\"
   version \"${VERSION}\"
   ...
   bottle do
      root_url \"https://github.com/lcscs/scs/releases/download/v${VERSION}\"
