...
void test_print::test_printn() {
   printn(lcscs::name{"1"}.value);
   printn(lcscs::name{"5"}.value);
   printn(lcscs::name{"a"}.value);
   printn(lcscs::name{"z"}.value);

   printn(lcscs::name{"abc"}.value);
   printn(lcscs::name{"123"}.value);

   printn(lcscs::name{"abc.123"}.value);
   printn(lcscs::name{"123.abc"}.value);

   printn(lcscs::name{"12345abcdefgj"}.value);
   printn(lcscs::name{"ijklmnopqrstj"}.value);
   printn(lcscs::name{"vwxyz.12345aj"}.value);

   printn(lcscs::name{"111111111111j"}.value);
   printn(lcscs::name{"555555555555j"}.value);
   printn(lcscs::name{"aaaaaaaaaaaaj"}.value);
   printn(lcscs::name{"zzzzzzzzzzzzj"}.value);
}
