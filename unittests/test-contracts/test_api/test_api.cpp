...
extern "C" {
   void apply( uint64_t receiver, uint64_t code, uint64_t action ) {
      if( code == "lcscs"_n.value && action == "onerror"_n.value ) {
         auto error = lcscs::onerror::from_current_action();
         lcscs::print("onerror called\n");
      ...
      //unhandled test call
      lcscs_assert( false, "Unknown Test ahhh!" );
