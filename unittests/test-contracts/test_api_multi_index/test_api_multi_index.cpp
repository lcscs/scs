...
namespace _test_multi_index {
   ...
   struct record_idx64 {
      ...
      scsLIB_SERIALIZE( record_idx64, (id)(sec) )
   };
   ...
   struct record_idx128 {
      ...
      scsLIB_SERIALIZE( record_idx128, (id)(sec) )
   };
   ...
   struct record_idx256 {
      ...
      scsLIB_SERIALIZE( record_idx256, (id)(sec) )
   };
   ...
   struct record_idx_double {
      ...
      scsLIB_SERIALIZE( record_idx_double, (id)(sec) )
   };
   ...
   struct record_idx_long_double {
      ...
      scsLIB_SERIALIZE( record_idx_long_double, (id)(sec) )
   };
