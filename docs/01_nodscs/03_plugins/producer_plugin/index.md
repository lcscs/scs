...
```console
# config.ini
plugin = lcscs::producer_plugin [options]
```
```sh
...
```console
Config Options for lcscs::producer_plugin:
  ...
  --private-key arg                     (DEPRECATED - Use signature-provider 
                                        ...
                                        times)
  --signature-provider arg (=scs6MRyAjQq8ud7hVNYcfnVPJqcVpscN5So8BhtHuGYqET5GDW5CV=KEY:5KQwrPbwdL6PhXujxW37FSSQZ1JiwsST4cqQzDeyXtP79zkvFD3)
                                        Key=Value pairs in the form 
                                        <public-key>=<provider-spec>
                                        Where:
                                           <public-key>    is a string form of 
                                                           a vaild lcscs public
                                                           key
                                           ...
                                           KscsD:<data>    is the URL where 
                                                           kscsd is available 
                                                           and the approptiate 
                                                           wallet(s) are 
                                                           unlocked
  --kscsd-provider-timeout arg (=5)     Limits the maximum time (in 
                                        milliseconds) that is allowed for 
                                        sending blocks to a kscsd provider for 
                                        signing
