...
## Command
A set of lcscs keys is required to create an account. The lcscs keys can be generated by using `clscs create key`.

```sh
clscs create account inita tester scs4toFS3YXEQCkuuw1aqDLrtHim86Gz9u3hBdcBw5KNPZcursVHq scs7d9A3uLe6As66jzN8j44TXJUqJSK3bFjjEEqR4oTvNAB3iM9SA
```
