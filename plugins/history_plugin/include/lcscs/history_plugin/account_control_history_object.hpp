...
CHAINBASE_SET_INDEX_TYPE( lcscs::account_control_history_object, lcscs::account_control_history_multi_index )

FC_REFLECT( lcscs::account_control_history_object, (controlled_account)(controlled_permission)(controlling_account) )
