...
CHAINBASE_SET_INDEX_TYPE( lcscs::public_key_history_object, lcscs::public_key_history_multi_index )

FC_REFLECT( lcscs::public_key_history_object, (public_key)(name)(permission) )
