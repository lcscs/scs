...
FC_REFLECT(lcscs::trace_api::authorization_trace_v0, (account)(permission))
FC_REFLECT(lcscs::trace_api::action_trace_v0, (global_sequence)(receiver)(account)(action)(authorization)(data))
FC_REFLECT(lcscs::trace_api::transaction_trace_v0, (id)(actions))
FC_REFLECT_DERIVED(lcscs::trace_api::transaction_trace_v1, (lcscs::trace_api::transaction_trace_v0), (status)(cpu_usage_us)(net_usage_words)(signatures)(trx_header))
FC_REFLECT(lcscs::trace_api::block_trace_v0, (id)(number)(previous_id)(timestamp)(producer)(transactions))
FC_REFLECT_DERIVED(lcscs::trace_api::block_trace_v1, (lcscs::trace_api::block_trace_v0), (transaction_mroot)(action_mroot)(schedule_version)(transactions_v1))
FC_REFLECT(lcscs::trace_api::cache_trace, (trace)(trx_header)(trx_signatures))