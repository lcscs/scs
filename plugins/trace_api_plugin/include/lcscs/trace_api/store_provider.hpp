...
#include <lcscs/trace_api/common.hpp>
#include <lcscs/trace_api/metadata_log.hpp>
#include <lcscs/trace_api/data_log.hpp>
#include <lcscs/trace_api/compressed_file.hpp>

namespace lcscs::trace_api {
...
FC_REFLECT(lcscs::trace_api::slice_directory::index_header, (version))
