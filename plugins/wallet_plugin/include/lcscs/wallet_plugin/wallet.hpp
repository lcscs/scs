...
#include <lcscs/wallet_plugin/wallet_api.hpp>
...
class soft_wallet final : public wallet_api
{
   public:
       ...
       *
       * example: remove_key scs6MRyAjQq8ud7hVNYcfnVPJqcVpscN5So8BhtHuGYqET5GDW5CV
       *
...
FC_REFLECT( lcscs::wallet::wallet_data, (cipher_keys) )

FC_REFLECT( lcscs::wallet::plain_keys, (checksum)(keys) )
