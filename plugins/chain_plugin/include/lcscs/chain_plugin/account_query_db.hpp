...
#include <lcscs/chain/block_state.hpp>
#include <lcscs/chain/trace.hpp>

namespace lcscs::chain_apis {
   /**
   ...
   public:
       ...
       */
      account_query_db( const class lcscs::chain::controller& chain );
      ~account_query_db();
...
namespace fc {
   using params = lcscs::chain_apis::account_query_db::get_accounts_by_authorizers_params;
   /**
   ...
   inline void from_variant(const fc::variant& v, params::permission_level& a) {
      if (v.is_string()) {
         ...
         if(vo.contains("actor"))
            ...
            scs_THROW(lcscs::chain::invalid_http_request, "Missing Actor field");
         ...
         if(vo.contains("permission") && vo.size() == 2)
            ...
            scs_THROW(lcscs::chain::invalid_http_request, "Unrecognized fields in account");
      }
   }
}

FC_REFLECT( lcscs::chain_apis::account_query_db::get_accounts_by_authorizers_params, (accounts)(keys))
FC_REFLECT( lcscs::chain_apis::account_query_db::get_accounts_by_authorizers_result::account_result, (account_name)(permission_name)(authorizing_account)(authorizing_key)(weight)(threshold))
FC_REFLECT( lcscs::chain_apis::account_query_db::get_accounts_by_authorizers_result, (accounts))
