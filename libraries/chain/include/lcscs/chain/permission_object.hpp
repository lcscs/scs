...
CHAINBASE_SET_INDEX_TYPE(lcscs::chain::permission_object, lcscs::chain::permission_index)
CHAINBASE_SET_INDEX_TYPE(lcscs::chain::permission_usage_object, lcscs::chain::permission_usage_index)

FC_REFLECT(lcscs::chain::permission_object, (usage_id)(parent)(owner)(name)(last_updated)(auth))
FC_REFLECT(lcscs::chain::snapshot_permission_object, (parent)(owner)(name)(last_updated)(last_used)(auth))

FC_REFLECT(lcscs::chain::permission_usage_object, (last_used))
