...
#include <lcscs/chain/action.hpp>
#include <numeric>
...
FC_REFLECT(lcscs::chain::deferred_transaction_generation_context, (sender_trx_id)(sender_id)(sender) )
FC_REFLECT( lcscs::chain::transaction_header, (expiration)(ref_block_num)(ref_block_prefix)
                                              (max_net_usage_words)(max_cpu_usage_ms)(delay_sec) )
FC_REFLECT_DERIVED( lcscs::chain::transaction, (lcscs::chain::transaction_header), (context_free_actions)(actions)(transaction_extensions) )
FC_REFLECT_DERIVED( lcscs::chain::signed_transaction, (lcscs::chain::transaction), (signatures)(context_free_data) )
FC_REFLECT_ENUM( lcscs::chain::packed_transaction::compression_type, (none)(zlib))
// @ignore unpacked_trx
FC_REFLECT( lcscs::chain::packed_transaction, (signatures)(compression)(packed_context_free_data)(packed_trx) )
