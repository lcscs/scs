...
FC_REFLECT( lcscs::chain::detail::block_header_state_common,
            (block_num)
...
FC_REFLECT( lcscs::chain::detail::schedule_info,
            (schedule_lib_num)
            (schedule_hash)
            (schedule)
)

FC_REFLECT_DERIVED(  lcscs::chain::block_header_state, (lcscs::chain::detail::block_header_state_common),
                     (id)
                     (header)
                     (pending_schedule)
...
FC_REFLECT( lcscs::chain::legacy::snapshot_block_header_state_v2::schedule_info,
          ( schedule_lib_num )
          ( schedule_hash )
          ( schedule )
)
...
FC_REFLECT( lcscs::chain::legacy::snapshot_block_header_state_v2,
          ( block_num )
          ( dpos_proposed_irreversible_blocknum )
          ( dpos_irreversible_blocknum )
          ( active_schedule )
