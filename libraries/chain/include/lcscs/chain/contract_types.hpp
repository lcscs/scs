...
using action_name    = lcscs::chain::action_name;
...
FC_REFLECT( lcscs::chain::newaccount                       , (creator)(name)(owner)(active) )
FC_REFLECT( lcscs::chain::setcode                          , (account)(vmtype)(vmversion)(code) )
FC_REFLECT( lcscs::chain::setabi                           , (account)(abi) )
FC_REFLECT( lcscs::chain::updateauth                       , (account)(permission)(parent)(auth) )
FC_REFLECT( lcscs::chain::deleteauth                       , (account)(permission) )
FC_REFLECT( lcscs::chain::linkauth                         , (account)(code)(type)(requirement) )
FC_REFLECT( lcscs::chain::unlinkauth                       , (account)(code)(type) )
FC_REFLECT( lcscs::chain::canceldelay                      , (canceling_auth)(trx_id) )
FC_REFLECT( lcscs::chain::onerror                          , (sender_id)(sent_trx) )
