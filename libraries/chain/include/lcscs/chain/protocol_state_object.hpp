...
CHAINBASE_SET_INDEX_TYPE(lcscs::chain::protocol_state_object, lcscs::chain::protocol_state_multi_index)

FC_REFLECT(lcscs::chain::protocol_state_object::activated_protocol_feature,
            (feature_digest)(activation_block_num)
          )

FC_REFLECT(lcscs::chain::protocol_state_object,
            (activated_protocol_features)(preactivated_protocol_features)(whitelisted_intrinsics)(num_supported_key_types)
          )

FC_REFLECT(lcscs::chain::snapshot_protocol_state_object,
            (activated_protocol_features)(preactivated_protocol_features)(whitelisted_intrinsics)(num_supported_key_types)
          )
