...
CHAINBASE_SET_INDEX_TYPE(lcscs::chain::code_object, lcscs::chain::code_index)

FC_REFLECT(lcscs::chain::code_object, (code_hash)(code)(code_ref_count)(first_block_used)(vm_type)(vm_version))
