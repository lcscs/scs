...
FC_REFLECT(lcscs::chain::protocol_feature_subjective_restrictions,
               (earliest_allowed_activation_time)(preactivation_required)(enabled))

FC_REFLECT(lcscs::chain::protocol_feature_base,
               (protocol_feature_type)(dependencies)(description_digest)(subjective_restrictions))

FC_REFLECT_DERIVED(lcscs::chain::builtin_protocol_feature, (lcscs::chain::protocol_feature_base),
