...
CHAINBASE_SET_INDEX_TYPE(lcscs::chain::permission_link_object, lcscs::chain::permission_link_index)

FC_REFLECT(lcscs::chain::permission_link_object, (account)(code)(message_type)(required_permission))
