...
FC_REFLECT_ENUM( lcscs::chain::transaction_receipt::status_enum,
                 (executed)(soft_fail)(hard_fail)(delayed)(expired) )

FC_REFLECT(lcscs::chain::transaction_receipt_header, (status)(cpu_usage_us)(net_usage_words) )
FC_REFLECT_DERIVED(lcscs::chain::transaction_receipt, (lcscs::chain::transaction_receipt_header), (trx) )
FC_REFLECT(lcscs::chain::additional_block_signatures_extension, (signatures));
FC_REFLECT_DERIVED(lcscs::chain::signed_block, (lcscs::chain::signed_block_header), (transactions)(block_extensions) )
