...
namespace std {
    template<> struct hash<lcscs::chain::scsvmoc::code_tuple> {
        size_t operator()(const lcscs::chain::scsvmoc::code_tuple& ct) const noexcept {
...
class code_cache_base {
   public:
      code_cache_base(const bfs::path data_dir, const scsvmoc::config& scsvmoc_config, const chainbase::database& db);
      ~code_cache_base();
...
class code_cache_async : public code_cache_base {
   public:
      code_cache_async(const bfs::path data_dir, const scsvmoc::config& scsvmoc_config, const chainbase::database& db);
      ~code_cache_async();
