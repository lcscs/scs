...
constexpr auto intrinsic_table = boost::hana::make_tuple(
   "scsvmoc_internal.unreachable"_s,
   "scsvmoc_internal.grow_memory"_s,
   "scsvmoc_internal.div0_or_overflow"_s,
   "scsvmoc_internal.indirect_call_mismatch"_s,
   "scsvmoc_internal.indirect_call_oob"_s,
   "scsvmoc_internal.depth_assert"_s,
   "lcscs_injection.call_depth_assert"_s,  //these two are never used by scs VM OC but all intrinsics
   "lcscs_injection.checktime"_s,          //must be mapped
   "env.__ashlti3"_s,
   "env.__ashrti3"_s,
   "env.__lshlti3"_s,
   "env.__lshrti3"_s,
   ...
   "env.abort"_s,
   "env.lcscs_assert"_s,
   "env.lcscs_assert_message"_s,
   "env.lcscs_assert_code"_s,
   "env.lcscs_exit"_s,
   ...
   "env.memcmp"_s,
   "env.memset"_s,
   "lcscs_injection._lcscs_f32_add"_s,
   "lcscs_injection._lcscs_f32_sub"_s,
   "lcscs_injection._lcscs_f32_mul"_s,
   "lcscs_injection._lcscs_f32_div"_s,
   "lcscs_injection._lcscs_f32_min"_s,
   "lcscs_injection._lcscs_f32_max"_s,
   "lcscs_injection._lcscs_f32_copysign"_s,
   "lcscs_injection._lcscs_f32_abs"_s,
   "lcscs_injection._lcscs_f32_neg"_s,
   "lcscs_injection._lcscs_f32_sqrt"_s,
   "lcscs_injection._lcscs_f32_ceil"_s,
   "lcscs_injection._lcscs_f32_floor"_s,
   "lcscs_injection._lcscs_f32_trunc"_s,
   "lcscs_injection._lcscs_f32_nearest"_s,
   "lcscs_injection._lcscs_f32_eq"_s,
   "lcscs_injection._lcscs_f32_ne"_s,
   "lcscs_injection._lcscs_f32_lt"_s,
   "lcscs_injection._lcscs_f32_le"_s,
   "lcscs_injection._lcscs_f32_gt"_s,
   "lcscs_injection._lcscs_f32_ge"_s,
   "lcscs_injection._lcscs_f64_add"_s,
   "lcscs_injection._lcscs_f64_sub"_s,
   "lcscs_injection._lcscs_f64_mul"_s,
   "lcscs_injection._lcscs_f64_div"_s,
   "lcscs_injection._lcscs_f64_min"_s,
   "lcscs_injection._lcscs_f64_max"_s,
   "lcscs_injection._lcscs_f64_copysign"_s,
   "lcscs_injection._lcscs_f64_abs"_s,
   "lcscs_injection._lcscs_f64_neg"_s,
   "lcscs_injection._lcscs_f64_sqrt"_s,
   "lcscs_injection._lcscs_f64_ceil"_s,
   "lcscs_injection._lcscs_f64_floor"_s,
   "lcscs_injection._lcscs_f64_trunc"_s,
   "lcscs_injection._lcscs_f64_nearest"_s,
   "lcscs_injection._lcscs_f64_eq"_s,
   "lcscs_injection._lcscs_f64_ne"_s,
   "lcscs_injection._lcscs_f64_lt"_s,
   "lcscs_injection._lcscs_f64_le"_s,
   "lcscs_injection._lcscs_f64_gt"_s,
   "lcscs_injection._lcscs_f64_ge"_s,
   "lcscs_injection._lcscs_f32_promote"_s,
   "lcscs_injection._lcscs_f64_demote"_s,
   "lcscs_injection._lcscs_f32_trunc_i32s"_s,
   "lcscs_injection._lcscs_f64_trunc_i32s"_s,
   "lcscs_injection._lcscs_f32_trunc_i32u"_s,
   "lcscs_injection._lcscs_f64_trunc_i32u"_s,
   "lcscs_injection._lcscs_f32_trunc_i64s"_s,
   "lcscs_injection._lcscs_f64_trunc_i64s"_s,
   "lcscs_injection._lcscs_f32_trunc_i64u"_s,
   "lcscs_injection._lcscs_f64_trunc_i64u"_s,
   "lcscs_injection._lcscs_i32_to_f32"_s,
   "lcscs_injection._lcscs_i64_to_f32"_s,
   "lcscs_injection._lcscs_ui32_to_f32"_s,
   "lcscs_injection._lcscs_ui64_to_f32"_s,
   "lcscs_injection._lcscs_i32_to_f64"_s,
   "lcscs_injection._lcscs_i64_to_f64"_s,
   "lcscs_injection._lcscs_ui32_to_f64"_s,
   "lcscs_injection._lcscs_ui64_to_f64"_s
);
