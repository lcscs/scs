...
FC_REFLECT( lcscs::chain::legacy::producer_key, (producer_name)(block_signing_key) )
FC_REFLECT( lcscs::chain::legacy::producer_schedule_type, (version)(producers) )
FC_REFLECT( lcscs::chain::block_signing_authority_v0, (threshold)(keys))
FC_REFLECT( lcscs::chain::producer_authority, (producer_name)(authority) )
FC_REFLECT( lcscs::chain::producer_authority_schedule, (version)(producers) )
FC_REFLECT_DERIVED( lcscs::chain::producer_schedule_change_extension, (lcscs::chain::producer_authority_schedule), )

FC_REFLECT( lcscs::chain::shared_block_signing_authority_v0, (threshold)(keys))
FC_REFLECT( lcscs::chain::shared_producer_authority, (producer_name)(authority) )
FC_REFLECT( lcscs::chain::shared_producer_authority_schedule, (version)(producers) )
