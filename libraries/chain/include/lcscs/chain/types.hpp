...
namespace lcscs { namespace chain {
   ...
   /**
    *  Important notes on using chainbase objects in lcscs code:
    *
    ...
    *  others are due to requirements to ensure determinism in the lcscs chain library.
    *
...
FC_REFLECT_EMPTY( lcscs::chain::void_t )
