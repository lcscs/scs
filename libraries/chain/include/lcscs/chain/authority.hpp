...
FC_REFLECT(lcscs::chain::permission_level_weight, (permission)(weight) )
FC_REFLECT(lcscs::chain::key_weight, (key)(weight) )
FC_REFLECT(lcscs::chain::wait_weight, (wait_sec)(weight) )
FC_REFLECT(lcscs::chain::authority, (threshold)(keys)(accounts)(waits) )
FC_REFLECT(lcscs::chain::shared_key_weight, (key)(weight) )
FC_REFLECT(lcscs::chain::shared_authority, (threshold)(keys)(accounts)(waits) )
FC_REFLECT(lcscs::chain::shared_public_key, (pubkey))