...
CHAINBASE_SET_INDEX_TYPE(lcscs::chain::transaction_object, lcscs::chain::transaction_multi_index)

FC_REFLECT(lcscs::chain::transaction_object, (expiration)(trx_id))
