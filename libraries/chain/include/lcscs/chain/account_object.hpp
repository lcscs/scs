...
#include <lcscs/chain/block_timestamp.hpp>
...
namespace lcscs { namespace chain {
   ...
   class account_object : public chainbase::object<account_object_type, account_object> {
      ...
      void set_abi( const lcscs::chain::abi_def& a ) {
         abi.resize( fc::raw::pack_size( a ) );
         fc::datastream<char*> ds( abi.data(), abi.size() );
         fc::raw::pack( ds, a );
      }

      lcscs::chain::abi_def get_abi()const {
         lcscs::chain::abi_def a;
         scs_ASSERT( abi.size() != 0, abi_not_found_exception, "No ABI set on account ${n}", ("n",name) );
...
CHAINBASE_SET_INDEX_TYPE(lcscs::chain::account_object, lcscs::chain::account_index)
CHAINBASE_SET_INDEX_TYPE(lcscs::chain::account_metadata_object, lcscs::chain::account_metadata_index)
CHAINBASE_SET_INDEX_TYPE(lcscs::chain::account_ram_correction_object, lcscs::chain::account_ram_correction_index)


FC_REFLECT(lcscs::chain::account_object, (name)(creation_date)(abi))
FC_REFLECT(lcscs::chain::account_metadata_object, (name)(recv_sequence)(auth_sequence)(code_sequence)(abi_sequence)
                                                  (code_hash)(last_code_update)(flags)(vm_type)(vm_version))
FC_REFLECT(lcscs::chain::account_ram_correction_object, (name)(ram_correction))
