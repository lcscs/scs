...
#include <lcscs/chain/incremental_merkle.hpp>
...
CHAINBASE_SET_INDEX_TYPE(lcscs::chain::global_property_object, lcscs::chain::global_property_multi_index)
CHAINBASE_SET_INDEX_TYPE(lcscs::chain::dynamic_global_property_object,
                         lcscs::chain::dynamic_global_property_multi_index)

FC_REFLECT(lcscs::chain::global_property_object,
            (proposed_schedule_block_num)(proposed_schedule)(configuration)(chain_id)
          )

FC_REFLECT(lcscs::chain::legacy::snapshot_global_property_object_v2,
            (proposed_schedule_block_num)(proposed_schedule)(configuration)
          )

FC_REFLECT(lcscs::chain::snapshot_global_property_object,
            (proposed_schedule_block_num)(proposed_schedule)(configuration)(chain_id)
          )

FC_REFLECT(lcscs::chain::dynamic_global_property_object,
