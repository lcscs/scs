...
#include <lcscs/chain/multi_index_includes.hpp>
...
CHAINBASE_SET_INDEX_TYPE(lcscs::chain::table_id_object, lcscs::chain::table_id_multi_index)
CHAINBASE_SET_INDEX_TYPE(lcscs::chain::key_value_object, lcscs::chain::key_value_index)

CHAINBASE_SET_INDEX_TYPE(lcscs::chain::index64_object, lcscs::chain::index64_index)
CHAINBASE_SET_INDEX_TYPE(lcscs::chain::index128_object, lcscs::chain::index128_index)
CHAINBASE_SET_INDEX_TYPE(lcscs::chain::index256_object, lcscs::chain::index256_index)
CHAINBASE_SET_INDEX_TYPE(lcscs::chain::index_double_object, lcscs::chain::index_double_index)
CHAINBASE_SET_INDEX_TYPE(lcscs::chain::index_long_double_object, lcscs::chain::index_long_double_index)

FC_REFLECT(lcscs::chain::table_id_object, (code)(scope)(table)(payer)(count) )
FC_REFLECT(lcscs::chain::key_value_object, (primary_key)(payer)(value) )

#define REFLECT_SECONDARY(type)\
  FC_REFLECT(type, (primary_key)(payer)(secondary_key) )

REFLECT_SECONDARY(lcscs::chain::index64_object)
REFLECT_SECONDARY(lcscs::chain::index128_object)
REFLECT_SECONDARY(lcscs::chain::index256_object)
REFLECT_SECONDARY(lcscs::chain::index_double_object)
REFLECT_SECONDARY(lcscs::chain::index_long_double_object)
