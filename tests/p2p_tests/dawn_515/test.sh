...
read -d '' genesis << EOF
{
  ...
  "initial_key": "scs6MRyAjQq8ud7hVNYcfnVPJqcVpscN5So8BhtHuGYqET5GDW5CV",
...
private-key = ['scs6MRyAjQq8ud7hVNYcfnVPJqcVpscN5So8BhtHuGYqET5GDW5CV','5KQwrPbwdL6PhXujxW37FSSQZ1JiwsST4cqQzDeyXtP79zkvFD3']
...
programs/lcscs-launcher/lcscs-launcher -p $pnodes -n $total_nodes --nogen -d $delay
...
b5idbios=`./programs/clscs/clscs -u http://localhost:8888 get block 5 | grep "^ *\"id\""`
b5id00=`./programs/clscs/clscs -u http://localhost:8889 get block 5 | grep "^ *\"id\""`
b5id01=`./programs/clscs/clscs -u http://localhost:8890 get block 5 | grep "^ *\"id\""`
