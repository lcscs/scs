...
###############################################################
# nodscs_short_fork_take_over_test
#
# Similar scenario to nodscs_forked_chain_test, except that there are only 3 producers and, after the "bridge" node is
...
try:
    ...
    if cluster.launch(prodCount=2, topo="bridge", pnodes=totalProducerNodes,
                      ...
                      useBiosBootFile=False, specificExtraNodscsArgs=specificExtraNodscsArgs, onlySetProds=True) is False:
